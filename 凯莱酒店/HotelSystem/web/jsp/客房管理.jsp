...
<div class="wholePage">
    ...
    <table class="administrator">
        ...
        <s:iterator value="roomTableEntityList" >    <!-- 遍历分割后的每条记录-->
            <tr class="fn">
                <td><s:property value="roomType"/> </td>
                <td><s:property value="roomId"/></td>
                <td><s:property value="roomStatus"/> </td>
                <td align="middle" ><a href="room_update.action?roomId=<s:property value="roomId"/>&status=<s:property value="roomStatus"/> ">修改状态</a></td>
            </tr>
        </s:iterator>
        </tbody>
    </table>
